...
$db = open_sqlite_db("secure/solarize.sqlite");
...
if (isset($_POST["submit_form"])) {
	...
	$hoursperday = filter_input(INPUT_POST, 'hoursperday', FILTER_SANITIZE_STRING);
	$daysperyear = filter_input(INPUT_POST, 'daysperyear', FILTER_SANITIZE_STRING);
}

if ($valid) {
	$sql = "INSERT INTO solarize (size, location, hoursperday, daysperyear) VALUES (:size, :location, :hoursperday, :daysperyear)";
	$params = array(
		':size' => $size,
		':location' => $location,
						...
						<div id="order_div">
	        				...
	        				<li class="order_field"><span class="order_field_title">Location: </span>
									...
									<li class="order_field"><span class="order_field_title">Hours Per Day: </span>
										...
										<input id="hours_input" type="number" step="0.01" name="hoursperday" placeholder="Hours" min="0" max="24" required/>

        					</li></br></br>

									<li class="order_field"><span class="order_field_title">Days Per Year: </span>

										<input id="days_input" type="number" name="daysperyear" placeholder="Days" min="0" max="365" required/>
					        ...
					        <li>
					          ...
					          <button id="order_form_button" type="submit" name="submit_form">Submit</button>
